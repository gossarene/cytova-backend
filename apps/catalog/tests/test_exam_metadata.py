...
class TestExamCreationWithMetadata:
    ...
    def test_create_with_family_only(self, family):
    ...
    def test_fasting_defaults_to_false(self, family):
        s = ExamDefinitionCreateSerializer(data={
            'family_id': str(family.id),
            'code': 'CRP',
    ...
    def test_create_without_sub_family_succeeds(self, family):
    ...
    def test_create_with_explicit_null_sub_family_succeeds(self, family):
        s = ExamDefinitionCreateSerializer(data={
            'family_id': str(family.id),
            'sub_family_id': None,
            'code': 'K-ONLY',
    ...
    def test_create_with_matching_sub_family_succeeds(self, family, sub_family):
        s = ExamDefinitionCreateSerializer(data={
            'family_id': str(family.id),
            'sub_family_id': str(sub_family.id),
            'code': 'PT-OK',
    ...
    def test_create_rejects_sub_family_from_other_family(self, family, sub_family):
        ...
        s = ExamDefinitionCreateSerializer(data={
            ...
            'sub_family_id': str(sub_family.id),  # belongs to Hematology, not Biochemistry
            'code': 'MISMATCH',
            'name': 'Mismatch Exam',
            'sample_type': 'BLOOD',
        })
...
class TestExamUpdateWithMetadata:
    ...
    def test_update_family_rejects_stale_sub_family(self, family, sub_family):
        """
    ...
    def test_update_family_with_sub_family_cleared_ok(self, family, sub_family):
    ...
    def test_update_unrelated_field_does_not_trigger_coherence(self, family, sub_family):
...
class TestExamFiltering:
    ...
    def exams(self, family, sub_family, tube_type, technique):
        ...
        e2 = ExamDefinition.objects.create(
            family=family, fasting_required=False,
...
class TestExamServiceWithMetadata:
    ...
    def test_create_via_service(self, family, tube_type, lab_admin, make_request):
